<template>
    ...
    <svg id="tile-front-svg" class="tile-svg" viewBox="0 0 268 232" :width="(268.3*2)" :height="(232.3 *2)">
        <defs>
            <svg:style type="text/css">
                ...
                .svg-damage-track-header-text,
                .svg-damage-track-result-text {
                font-family:'Roboto Condensed';
                font-size: 5pt;
                font-weight: bold;
                fill: #fff;
	...
	C4.5,5.6,4.3,6,4.6,6.3C4.7,6.4,4.8,6.5,5,6.5c0.2,0,0.3-0.1,0.4-0.2C5.7,6,5.5,5.6,5.4,5.4z"/>
	 ...
	 M6.6,1.5H3.4L2.8,3.1v1.1C3.4,4.3,4.2,4.4,5,4.4c0.8,0,1.6-0.1,2.2-0.3V3.1L6.6,1.5z"/>
        ...
        <image :href="frontSourceImageUrl" width="100%" height="100%" clip-path="url(#tile-clip)"/>
        ...
        <template v-if="stealth">
            <g id="stealth">
                <polygon id="stealth-bg" class="icon-gray"
        ...
        <g id="evasion">
            <polygon id="evasion-bg" class="icon-gray"
        ...
        <g id="move">
            <polygon id="move-bg" class="icon-gray"
        ...
        <text :x="268.3 * 0.5" y="20" class="svg-title">{{tile_name}}</text>
        <text :x="268.3 * 0.5" y="32" class="svg-subtitle">{{printSubTitle}}</text>
