<template>
	...
	C4.5,5.6,4.3,6,4.6,6.3C4.7,6.4,4.8,6.5,5,6.5c0.2,0,0.3-0.1,0.4-0.2C5.7,6,5.5,5.6,5.4,5.4z"/>
	 ...
	 M6.6,1.5H3.4L2.8,3.1v1.1C3.4,4.3,4.2,4.4,5,4.4c0.8,0,1.6-0.1,2.2-0.3V3.1L6.6,1.5z"/>
            ...
            <g id="fire" transform="translate(-5, 0)">
                <path d="M8.2,6.9c0,0,0-0.1-0.1-0.1C8.1,6.6,8,6.5,8,6.4C7.9,6.2,7.7,6,7.6,5.8c0,0,0,0.2-0.2,0.5c0,0,0,0,0,0l0,0
	C7.3,6.7,7,7.1,6.6,7.3C6.8,6.9,7,6.4,7.1,6c0.6-2.5-0.4-4.3-2.1-5.2c0.7,0.9,0.2,1.8-0.5,2.7l-1,1.1c-0.5,0.5-1,1-1.2,1.6
	C1.1,8.5,2.6,10,3.8,10.8C3.2,9.3,3.8,7.4,5.2,6.6c-0.4,1,1,2.4,0.6,3.8C6.1,10,6.6,9.7,6.5,9.3c0.3,0.2,0.6,0.9,0.4,1.6
	c0.2-0.1,0.4-0.3,0.5-0.4c0.1-0.1,0.2-0.2,0.3-0.3c0.1-0.1,0.1-0.1,0.2-0.2C7.9,9.9,8,9.8,8,9.7c0.1-0.1,0.2-0.3,0.2-0.4l0,0
	C8.6,8.5,8.5,7.7,8.2,6.9z"/>
            </g>
        </defs>
