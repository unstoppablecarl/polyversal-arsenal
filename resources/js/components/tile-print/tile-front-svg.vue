<template>
	...
	C4.5,5.6,4.3,6,4.6,6.3C4.7,6.4,4.8,6.5,5,6.5c0.2,0,0.3-0.1,0.4-0.2C5.7,6,5.5,5.6,5.4,5.4z"/>
	 ...
	 M6.6,1.5H3.4L2.8,3.1v1.1C3.4,4.3,4.2,4.4,5,4.4c0.8,0,1.6-0.1,2.2-0.3V3.1L6.6,1.5z"/>
            ...
            <g id="damage-fire" transform="translate(-5, 0)">
                <path d="M6.5,4.5L6.5,4.5c0-0.1-0.1-0.2-0.1-0.2c0-0.1-0.1-0.2-0.2-0.3c0,0,0,0.1-0.1,0.2l0,0l0,0c0,0.2-0.2,0.4-0.4,0.5
	C5.8,4.5,5.9,4.3,6,4.1C6.3,2.9,5.8,2,5,1.5c0.3,0.4,0.1,0.9-0.2,1.3L4.2,3.4C4,3.6,3.7,3.9,3.6,4.2C3,5.3,3.8,6.1,4.4,6.5
	c-0.3-0.8,0-1.7,0.7-2.1C4.9,4.9,5.5,5.6,5.4,6.3C5.5,6.1,5.8,6,5.7,5.8c0.1,0,0.3,0.4,0.2,0.7c0.1,0,0.2-0.1,0.2-0.2l0.1-0.1
	c0,0,0,0,0.1-0.1V6c0,0,0.1-0.1,0.1-0.2l0,0C6.7,5.3,6.7,4.9,6.5,4.5z"/>
            </g>
        </defs>
