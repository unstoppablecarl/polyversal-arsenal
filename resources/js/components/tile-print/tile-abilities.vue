<template>
    <g>
		...
		L7,2.6l1.2-2.4L2.9,2.3L3.7,3.9z M6.5,3.6L5,6.5L4,4.6L6.5,3.6z M2.6,1.7L1.8,0h4.8L2.6,1.7z"/>
                ...
                <template v-if="ability.name === 'repair' || ability.name === 'repair_team'">
                ...
                <template v-if="ability.name === 'ews' || ability.name === 'ews_communications_center'">
                ...
                <template v-if="ability.name === 'fire_suppression_system'">
                    <path d="M6.3,8.5C6.1,9,5.7,9.5,5,10c0.2-0.7-0.1-1.3-0.4-1.6C4.7,8.8,4.3,9.2,4,9.6c0.3-1.4-1-2.8-0.7-3.8c-1.5,0.8-2,2.7-1.4,4.2
	C0.7,9.2-0.8,7.7,0.4,5.4c0.3-0.5,0.7-1,1.2-1.6L6.3,8.5z M6.4,6.4C6.3,5.8,5.9,5.3,5.7,5c0,0.2-0.1,0.3-0.2,0.5L5.2,5.2
	C5.8,2.7,4.8,0.9,3.1,0c0.7,0.9,0.2,1.8-0.5,2.7L1,1L0.4,1.5l1.8,1.8L5,6.1l0.1,0.1l1.4,1.4l1,1L8,8.1L6.4,6.4z"/>
                </template>

                <template v-if="ability.name === 'security_system'">
                    <path d="M1.9,3.7H0.7v-1C0.7,1.2,1.9,0,3.4,0s2.7,1.2,2.7,2.7v1H5v-1c0-0.9-0.7-1.5-1.5-1.5S1.9,1.8,1.9,2.7V3.7z M6.9,4.3V10H0V4.3
	H6.9z M4.3,6.3c0-0.5-0.4-0.9-0.9-0.9S2.6,5.8,2.6,6.3c0,0.4,0.2,0.7,0.6,0.8v1.8h0.6V7.1C4.1,7,4.3,6.7,4.3,6.3z"/>
                </template>

                <template v-if="ability.name === 'fallout_shelter'">
                    <path d="M5,0C2.2,0,0,2.2,0,5c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C10,2.2,7.8,0,5,0z M2.6,9.1L0.2,5H5L2.6,9.1z M5,5L2.6,0.9h4.8L5,5z
	 M7.4,9.1L5,5h4.8L7.4,9.1z"/>
                </template>
            </g>
        </g>
    </g>
