<template>
    ...
    <svg id="tile-back-svg" class="tile-svg" viewBox="0 0 268 232" :width="(268.3*2)" :height="(232.3 *2)">
        <defs>
        ...
        <image :href="backSourceImageUrl" width="100%" height="100%" clip-path="url(#tile-clip)"/>
